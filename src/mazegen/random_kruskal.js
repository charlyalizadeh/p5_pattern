class RandomKruskal extends MazeGen {
    constructor(maze) {
        ...
        for(let x = 0; x < maze.width; x++) {
            for(let y = 0; y < maze.height; y++) {
                ...
                walls.push(...maze.get_wall_on([x, y], ["bottom", "left"]));
            }
        }
    ...
    run_step() {
        ...
        let cell2 = this.maze.get_inter_cell(cell1, this.current_wall[2]);
        if(cell2 == null)
            return true;
        if(this.cell_sets.find(cell1) != this.cell_sets.find(cell2)) {
            ...
            this.maze.set_cell_state(index2, true);
